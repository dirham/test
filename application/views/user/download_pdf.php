...
<h1 style="color: blue; text-align: center"><u>Sistem Informasi Mahasiswa Online - AKBID SUMBER KASIH</u></h1>
<br>
<h2><i>Informasi Nilai Mahasiswa </i></h2>
...
<table border="1" cellpadding="0" cellspacing="0">
    <tbody>
        ...
        <tr>
            ...
            <td style="background: #ccc; text-align:center" width="50"><?php echo l($total_sks) ?></td>
            <td style="background: #ccc; text-align:center" width="70"></td>
            <td style="background: #ccc; text-align:center" width="50"></td>
            <td style="background: #ccc; text-align:center" width="50"><?php echo l($total_mutu) ?></td>
        </tr>
            <?php
            if (0!=$total_sks)
        ...
        <tr>
            ...
            <td style="background: #ccc;" colspan="6" rowspan="1" width="700px">&nbsp;<?php echo l($total_mutu) ?>:<?php echo l($total_sks) ?> = <?php echo l($nilai_ips1)?></td>
        </tr>
        <tr>
...
<table border="1" cellpadding="0" cellspacing="0">
    <tbody>
        ...
        <tr>
            <td style="background: #ccc; text-align:center" width="50"><strong>Nilai IPS :</strong></td>
            <td style="background: #ccc;" colspan="6" rowspan="1" width="700px">&nbsp;<?php echo l($total_mutu) ?>:<?php echo l($total_sks) ?> = <?php echo l($nilai_ips2)?></td>
        </tr>
        <tr>
            <td style="background: #ccc; text-align:center" width="50"><strong>Nilai IPK :</strong></td>
            <td style="background: #ccc;" colspan="6" rowspan="1" width="700px">
